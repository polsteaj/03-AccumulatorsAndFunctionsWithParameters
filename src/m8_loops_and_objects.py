...
def draw_circles1():
    ...
    for k in range(21):
        temp = rg.Circle(rg.Point(200, 200), k*10)
...
def draw_circles2():
    ...
    window = rg.RoseWindow(400, 400)
    for k in range(18):
        temp = rg.Circle(rg.Point(50+(k*20), 100), 10)
        temp.attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_circles3():
    ...
    for k in range(100):
        temp = rg.Circle(rg.Point(200, 150), k+1)
        temp.attach_to(window)
    window.render()
    window.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    window = rg.RoseWindow(400, 400)
    for k in range(101):
        center = rg.Point(200+(80*(mth.cos(k))), 200 + (80 * (mth.sin(k))))
        temp = rg.Circle(center, 10)
        temp.attach_to(window)
    window.render()
    window.close_on_mouse_click()
